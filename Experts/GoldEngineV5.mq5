...
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, GoldEngine V2"
#property link      "https://github.com/goldv2"
#property version   "5.50"
#property description "GITS V5.5.0: Performance Recovery Release"
...
//--- Input Group: === 🎯 V5 INSTITUTIONAL MOMENTUM SNIPER ENGINE ===
input group "=== 🎯 V5 INSTITUTIONAL MOMENTUM SNIPER ENGINE ==="
input double   InpMinCandleBodyPips      = 5.0;            // [SNIPER] Minimum M15 Candle Body (Pips)
input double   InpMinVolumeRatio         = 1.2;            // [SNIPER] Minimum Volume Ratio vs 20 MA
...
input bool     InpEnableProfitLock       = false;          // [EXIT] Enable Progressive Profit Lock (Off by default to let trades hold across candles)
...
public:
   ...
   bool OnInit()
   {
      ...
      m_config.SetMinCandleBodyPips(InpMinCandleBodyPips);
      m_config.SetMinVolumeRatio(InpMinVolumeRatio);
