...
private:
   ...
   double            m_minCandleBodyPips; // V5 Momentum Sniper: Min M15 Candle Body (Pips)
   double            m_minVolumeRatio;    // V5 Momentum Sniper: Min Tick Volume Ratio vs 20 MA
...
public:
   ...
   CConfig()
   {
      ...
      m_minCandleBodyPips        = 5.0;   // V5 Momentum Sniper: Default 5.0 pips minimum candle body
      m_minVolumeRatio           = 1.2;   // V5 Momentum Sniper: Default 1.2x volume ratio
   ...
   // V5 Momentum Sniper Getters & Setters
   double GetMinCandleBodyPips() const { return m_minCandleBodyPips; }
   double GetMinVolumeRatio() const { return m_minVolumeRatio; }
   void SetMinCandleBodyPips(double val) { m_minCandleBodyPips = val; }
   void SetMinVolumeRatio(double val) { m_minVolumeRatio = val; }
